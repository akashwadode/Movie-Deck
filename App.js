...
async function showMovies(pageNumber = 1, sort_by = "desc") {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0NmU0YjkwZGY2M2QwYTVhNzYwOTI4NzQwYzU3YzEyOSIsInN1YiI6IjY0ZDUwNWI3ZjQ5NWVlMDI5MjRkNDg2NyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.FUWEKkoP8kk8MvZleA46sBKqlwFtd8hpvkZRD544M8w",
    },
  };
  let response;

  response = await fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=46e4b90df63d0a5a760928740c57c129&include_adult=false&language=en-US&page=${pageNumber}&sort_by=${
